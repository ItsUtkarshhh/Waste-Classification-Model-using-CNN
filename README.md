...
This project is based on Waste Classification, where we have classified the wastes into two categories, Organic and Inorganic and have build a machine learning model. and then an interface which will take images as input and will predict that the image is of an organic waste or an inorganic waste.
=======
...
* Enjoy!
>>>>>>> 41132b35 (Initial commit - adding project files)
